...
const Orcamento = () => {
  ...
  // Se vier por redirecionamento do Precificador, preencher campos iniciais
  useEffect(() => {
    if (location.state) {
      if (location.state.modelName) setModelName(location.state.modelName);
      if (location.state.unitPrice) setUnitPrice(location.state.unitPrice);
